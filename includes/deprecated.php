 ...
 * @deprecated 2.0.0
 */
global $Show_Hide_tinymce_widget_version; // global is necessary because this file is included in a non-global context
$Show_Hide_tinymce_widget_version = Show_Hide_TinyMCE_Plugin::$version;
 ...
 * @deprecated 1.4
 */
global $Show_Hide_tinymce_widget_dev_mode ; // global is necessary because this file is included in a non-global context
$Show_Hide_tinymce_widget_dev_mode = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG;

/**
 * @since 1.4.0
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_get_version() {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_widgets_init() {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_admin_init() {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_load_tiny_mce() {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_init_editor( $arg ) {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_styles() {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_scripts() {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_footer_scripts() {
 ...
 * @deprecated 0.7.0
 */
function Show_Hide_tinymce_preload_dialogs() {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_apply_smilies_to_widget_text( $text ) {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_upload_iframe_src( $arg ){
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_editor_accessibility_mode( $editor ) {
 ...
 * @deprecated 2.0.0
 */
function Show_Hide_tinymce_siteorigin_panels_widget_object( $the_widget ) {
