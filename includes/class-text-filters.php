...
if ( ! class_exists( 'Show_Hide_TinyMCE_Text_Filters' ) ) {

	final class Show_Hide_TinyMCE_Text_Filters {
		...
		public function need_wpautop( $instance ) {
			...
			$need_wpautop = apply_filters( 'Show_Hide_tinymce_need_wpautop', $need_wpautop, $instance );
			return $need_wpautop;
		}
	...
	} // END class Show_Hide_TinyMCE_Text_Filters
