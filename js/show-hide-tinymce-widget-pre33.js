...
(function( $ ) {
	...
	$( document ).ready(function() {
		...
		$( 'div.widget[id*=show-hide-tinymce] .widget-title, div.widget[id*=show-hide-tinymce] a.widget-action' ).live( 'click', function() {
		...
		$( 'div.widget[id*=show-hide-tinymce] input[name=savewidget]' ).live( 'click', function() {
			if ( bstw( $( this ) ).is_tinymce_active() ) {
				bstw( $( this ) ).deactivate();
			}
			// Event handler for ajax complete
		...
		$( 'a[id^=widget-show-hide-tinymce][id$=tmce]' ).live( 'click', function() {
			bstw( $( this ) ).set_mode( 'visual' );
		});

		// Event handler for html switch button
		$( 'a[id^=widget-show-hide-tinymce][id$=html]' ).live( 'click', function() {
