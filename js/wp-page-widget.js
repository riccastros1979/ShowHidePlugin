/* Show Hide TinyMCE Widget - Compatibility with WP Page Widget plugin */
...
(function( $ ) {
	...
	$( document ).ready(function() {
		...
		$( document ).on( 'click', '#pw-sidebars-customize div[id*=show-hide-tinymce].widget input.widget-control-save', function() {
		...
		$( document ).on( 'click', '#pw-sidebars-customize div[id*=show-hide-tinymce].widget .widget-title', function() {
